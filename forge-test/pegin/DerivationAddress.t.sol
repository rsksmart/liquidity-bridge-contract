...
contract DerivationAddressTest is Test {
    ...
    function test_ValidatePegInDepositAddress_FunctionExists() public {
        ...
        assertTrue(address(pegInMainnet) != address(0), "Mainnet contract should be deployed");
        assertTrue(address(pegInTestnet) != address(0), "Testnet contract should be deployed");
    ...
    function createTestQuote1() internal pure returns (Quotes.PegInQuote memory) {
    ...
    function createTestQuote2() internal pure returns (Quotes.PegInQuote memory) {
        bytes memory testBtcAddress = new bytes(21);
    ...
    function createTestQuote3() internal pure returns (Quotes.PegInQuote memory) {
        bytes memory testBtcAddress = new bytes(21);
