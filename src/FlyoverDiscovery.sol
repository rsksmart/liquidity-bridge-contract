    ...
    IFlyoverDiscovery
{
    ...
    /// @dev A provider is listed if it is registered and has the min collateral
    ...
    function _shouldBeListed(Flyover.LiquidityProvider storage lp) private view returns(bool){
        return _collateralManagement.isCollateralSufficient(lp.providerType, lp.providerAddress);
    }
