...
interface IPegOut is IPausable, IERC5267 {
    ...
    /// @dev Only callable by the wired PegOutEscrow. Quote terms stay on escrow; this contract only
    /// records claim timing / completion. Settlement reads the quote from escrow when CLAIMED.
