 ...
 *   ./script/tasks/refund-user-pegout.sh --quote-hash <hash> --network rskTestnet
 *
 *   # Execute refund (broadcast transaction)
 *   ./script/tasks/refund-user-pegout.sh --quote-hash <hash> --network rskTestnet --broadcast --private-key <key>
 *
 ...
 *   ./script/tasks/refund-user-pegout.sh \
 *     --quote-hash abc123... \
 *     --network rskTestnet
 *
...
contract RefundUserPegout is Script {
    string constant HELPER_SCRIPT = "script/helpers/parse-btc-address.ts";
