 ...
 *   ./script/tasks/hash-quote.sh --type pegin --file quote.json
 *   ./script/tasks/hash-quote.sh --type pegout --file quote.json --rpc-url http://localhost:4444
 *
 ...
 *   LBC_ADDRESS=0x1234... ./script/tasks/hash-quote.sh --type pegin --file script/tasks/hash-quote.example.json
 *
 *   # Using forge directly
 *   forge script script/tasks/HashQuote.s.sol:HashQuote \
 *     --sig "hashPeginQuote(string)" "script/tasks/hash-quote.example.json" \
