...
contract LiquidityBridgeContract is Initializable, OwnableUpgradeable {
  ...
  */
  ...
  function withdrawCollateral() external {
    ...
    require(
      block.number - resignationBlockNum[msg.sender] >= resignDelayInBlocks,
      "Not enough blocks"
    );
  ...
  function registerPegIn(
    ...
    require(
      transferredAmountOrErrorCode != BRIDGE_UNPROCESSABLE_TX_VALIDATIONS_ERROR,
    ...
    require(
      transferredAmountOrErrorCode != BRIDGE_UNPROCESSABLE_TX_VALUE_ZERO_ERROR,
  ...
  function refundUserPegOut(
    ...
    emit PegOutUserRefunded(quoteHash, valueToTransfer, quote.rskRefundAddress);
  }
  ...
  function refundPegOut(
    ...
    require(block.number <= quote.expireBlock, "LBC: Quote expired by blocks");
