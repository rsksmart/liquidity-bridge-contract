...
contract BridgeMock is Bridge {
    ...
    function getFederatorPublicKey ( int256 ) external pure override returns (bytes memory) {bytes memory b; return b;}
    function getFederatorPublicKeyOfType ( int256, string calldata ) external pure override returns (bytes memory) {bytes memory b; return b;}
    ...
    function getRetiringFederatorPublicKey ( int256 ) external override  pure returns (bytes memory) {bytes memory b; return b;}
    function getRetiringFederatorPublicKeyOfType ( int256,string calldata ) external pure override returns (bytes memory) {bytes memory b; return b;}
    function getRetiringFederationCreationTime (  ) external pure override returns (int256) {return int256(0);}
    function getRetiringFederationCreationBlockNumber (  ) external override  pure returns (int256) {return int256(0);}
    function createFederation (  ) external pure override returns (int256) {return int256(0);}
    function addFederatorPublicKey ( bytes calldata ) external pure override returns (int256) {return int256(0);}
    function addFederatorPublicKeyMultikey ( bytes calldata , bytes calldata , bytes calldata  ) external pure override returns (int256) {return int256(0);}
    ...
    function getPendingFederatorPublicKey ( int256  ) external pure override returns (bytes memory) {bytes memory b; return b;}
    function getPendingFederatorPublicKeyOfType ( int256 , string calldata  ) external pure override returns (bytes memory) {bytes memory b; return b;}
    ...
    function getLockWhitelistEntryByAddress ( string calldata  ) external pure  override returns (int256) {return int256(0);}
    function addLockWhitelistAddress ( string calldata , int256  ) external pure override returns (int256) {return int256(0);}
    function addOneOffLockWhitelistAddress ( string calldata , int256  ) external pure override returns (int256) {return int256(0);}
    function addUnlimitedLockWhitelistAddress ( string calldata  ) external pure override returns (int256) {return int256(0);} 
    function removeLockWhitelistAddress ( string calldata  ) external pure override returns (int256) {return int256(0);}
    function setLockWhitelistDisableBlockDelay ( int256  ) external pure override returns (int256) {return int256(0);}
